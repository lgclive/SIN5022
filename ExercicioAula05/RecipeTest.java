...
public class RecipeTest {
    ...
    @Test
    public void testCreateInvalidRecipeNegativeAmtCoffee() throws InvalidValueException {
        assertThrows(InvalidValueException.class, ()-> new Recipe("Coffee",50, -4,0,1,1));
    }

    @Test
    public void testCreateInvalidRecipeNegativeAmtSugar() throws InvalidValueException {
        assertThrows(InvalidValueException.class, ()-> new Recipe("Coffee",50, 4,0,-1,1));
    }

    @Test
    public void testCreateNullRecipeName() throws InvalidValueException{
        assertThrows(InvalidValueException.class, () ->new Recipe(null,50,4,1,1,1));
    }
}
